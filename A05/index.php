...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-white w3-wide w3-padding w3-card">
            <a href="#home" class="w3-bar-item w3-button"><b>IP</b> Buloy</a>
    ...
    <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
        <img class="w3-image" src="./assets/cover.jpg" alt="Architecture" width="1500" height="800">
  ...
  -->
        ...
        <div class="w3-container w3-padding-32" id="about">
            ...
            <p>This is my Island of Personality — a place where different aspects of who I am come together to form a
                unique and ever-evolving landscape. Each island represents a specific facet of my character, where my
                traits, values, and tendencies coexist, sometimes harmoniously, sometimes in contrast. Just like an
                archipelago, these islands shape my identity, influencing how I perceive the world and interact with
                others.
            </p>
        </div>
